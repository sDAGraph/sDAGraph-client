...
func TestSignbatch(t *testing.T) {
	...
	//insert file
	err := sDAGraph_mongo.InsertFile(d,"test","/home/administrator/gomiketest/SpaceMoney.mp4")
	fmt.Println("insert file err:",err)

	time.Sleep(10)
	err2 := sDAGraph_mongo.DloadFile(d,"test","/home/administrator/SpaceMoney.mp4")
	fmt.Println("dload file err:",err2)
